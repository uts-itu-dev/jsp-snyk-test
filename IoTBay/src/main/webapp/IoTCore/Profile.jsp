					...
					if (base.getType() == EUserType.CUSTOMER) {
						...
						if (active != null) {
							...
							out.println(
								...
								+ "<tr><td><label for=\"First\">First Name:</label><div class=\"field\"><input type=\"text\" placeholder=\"First Name\" name=\"First\" value=\"" + active.getFirstName() + "\" required></div></td></tr>"
								+ "<tr><td><label for=\"Last\">Last Name:</label><div class=\"field\"><input type=\"text\" placeholder=\"Last Name\" name=\"Last\" value=\"" + active.getLastName() + "\" required></div></td></tr>"
								...
								+ "<div class=\"field\"><input type=\"password\" placeholder=\"Current Password\" name=\"Password\" required></div>"
								+ "</td></tr>"
								+ "<tr><td><label for=\"Pass1\">New Password:</label>"
								+ "<div class=\"field\"><input type=\"password\" placeholder=\"New Password\" name=\"Pass1\" required></div>"
								+ "</td></tr>"
								+ "<tr><td><label for=\"Pass2\">Confirm Password:</label>"
								+ "<div class=\"field\"><input type=\"password\" placeholder=\"Confirm Password\" name=\"Pass2\" required></div>"
								+ "</td></tr>"
								...
								+ "<div class=\"field\"><input type=\"email\" placeholder=\"E-Mail Address\" name=\"Email\" value=\"" + active.getEmail() + "\" required></div>"
								+ "</td></tr>"
								+ "<tr><td><div class=\"field\"><input type=\"submit\" value=\"Update\"></div></td><td>"
								...
								+ "<div class=\"field\"><input type=\"number\" placeholder=\"Phone Number\" name=\"PhoneNumber\" value=\"" + active.getPhoneNumber() + "\"></div>"
								+ "</td></tr>"
								+ "<tr><td><div class=\"field\"><input type=\"submit\" value=\"Update\"></div></td><td>"
								...
								+ "<div class=\"field\"><input type=\"number\" placeholder=\"Street Number\" name=\"addNum\" value=\"" + active.getAddress().getNumber() + "\"></div>"
								+ "</td></tr>"
								...
								+ "<div class=\"field\"><input type=\"number\" placeholder=\"Postcode\" name=\"addPostcode\" value=\"" + active.getAddress().getPostcode() + "\"></div>"
								+ "</td></tr>"
								...
								+ "<div class=\"field\"><input type=\"number\" placeholder=\"Card Number\" name=\"CardNo\" value=\"" + cn + "\"></td></tr></div>"
								+ "<tr><td><label for=\"CVV\">CVV:</label>"
								+ "<div class=\"field\"><input type=\"number\" placeholder=\"CVV\" name=\"CVV\" value=\"" + cvv + "\"></td></tr></div>"
